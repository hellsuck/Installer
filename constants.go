...
const ReleaseUrl = "https://api.github.com/repos/hellsuck/vencordradiant/releases/latest"
const ReleaseUrlFallback = "https://vencord.dev/releases/vencord"
const InstallerReleaseUrl = "https://api.github.com/repos/hellsuck/Installer/releases/latest"
